...
export default function NotificationDropdown() {
  ...
  return (
    <div className="relative">
      <button
        className="dropdown-toggle relative flex size-11 items-center justify-center rounded-full border border-gray-200 bg-white text-black transition-colors hover:bg-gray-100 hover:text-gray-700 dark:border-white dark:bg-black dark:text-gray-400 dark:hover:bg-[#1ffa02] dark:hover:text-white"
        onClick={handleClick}
      >
        <span
          className={`absolute right-0 top-0.5 z-10 size-2 rounded-full bg-orange-400 ${!notifying ? "hidden" : "flex"}`}
        >
        ...
        <ul className="custom-scrollbar flex h-auto flex-col overflow-y-auto">
          ...
          <li>
            <DropdownItem
              ...
              className="px-4.5 flex gap-3 rounded-lg border-b border-gray-100 p-3 hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-white/5"
            >
